...
(function (com) {
    ...
    (function (MyClass) {
        ...
        (function (MyView) {
            ...
            var MyMouseEventStarling = /** @class */ (function () {
                ...
                MyMouseEventStarling.prototype.setValue = function (str, val) {
                    ...
                    switch (str) {
                        ...
                        case "暂停":
                            ...
                            break;
                        case "停止冒泡":
                            this.stopEventMop = true;
                            break;
                        case "滚轮":
                            if (val == null) {
                                if (this.Dic_roll) {
                                    MyClass.Config.mStage.off(laya.events.Event.MOUSE_WHEEL, this, this.onMouseWheel);
                                ...
                                if (this.Dic_roll == null) {
                                    this.Dic_roll = {};
                                    MyClass.Config.mStage.on(laya.events.Event.MOUSE_WHEEL, this, this.onMouseWheel);
                                }
                                else {
                ...
                MyMouseEventStarling.prototype.onMouseWheel = function (e) {
                ...
                MyMouseEventStarling.prototype.newDicClick = function () {
                    if (this.Dic_Click)
                        return;
                 ...
                 * 鼠标响应事件处理
                 */
                MyMouseEventStarling.prototype.mouseHandler = function (e) {
                    if (e === void 0) { e = null; }
                    if (this.MC == null)
                        return;
                    var p = {};
                    ...
                    var pl = this.MC.globalToLocal(new laya.maths.Point(p["globalX"], p["globalY"]));
                    p["x"] = pl.x;
                    p["y"] = pl.y;
                ...
                MyMouseEventStarling.prototype.onRunF = function (f, arg) {
                ...
                MyMouseEventStarling.prototype.downF = function (p) {
                    ...
                    if (this.Dic_Click != null) {
                        ...
                        if (this.Dic_Click["fun_down"] != null)
                            this.onRunF(this.Dic_Click["fun_down"], [p]);
                    }
                    if (this.Dic_Slide != null) {
                        ...
                        if (this.FunEnter == null)
                            this.FunEnter = Handler.create(this, this.enterFrameF, null, false);
                        MyClass.MainManager.getInstence().addEnterFrameFun(this.FunEnter);
                    }
                };
                MyMouseEventStarling.prototype.upF = function (p) {
                    if (this.pausing == true)
                        return;
                    ...
                    if (this.Dic_Slide != null && this.Dic_Slide["开始移动"] == true && p != null) {
                        ...
                        var dic = {};
                        dic["类型"] = "滑动";
                        if (Math.abs(this.Dic_Slide["x速度"]) >= this.Dic_Slide["满足滑动速度"])
                            dic["x"] = this.Dic_Slide["x速度"];
                        else
                            dic["x"] = 0;
                        if (Math.abs(this.Dic_Slide["y速度"]) >= this.Dic_Slide["满足滑动速度"])
                            dic["y"] = this.Dic_Slide["y速度"];
                        else
                            dic["y"] = 0;
                        dic["gx"] = lx;
                        dic["gy"] = ly;
                ...
                MyMouseEventStarling.prototype.moveF = function (p) {
                    if (this.pausing == true || p == null)
                        return;
                    if (this.isDown == false)
                        return;
                    var lx = p.globalX;
                    ...
                    if (this.Dic_Slide == null) {
                        if (this.Dic_Click && this.Dic_Click["开始移动"] != true) {
                            ...
                            L = Math.sqrt(L);
                            if (L > this.LStartMove)
                                this.Dic_Click["开始移动"] = true;
                        }
                        return;
                    }
                    this.Dic_Slide["计时"] = 3;
                    ...
                    if (this.Dic_Slide["开始移动"] == true) {
                        ...
                        dic["类型"] = "移动";
                        if (lx != 0)
                            dic["x"] = lx - this.Dic_Slide["上次x"];
                        else
                            dic["x"] = 0;
                        if (ly != 0)
                            dic["y"] = ly - this.Dic_Slide["上次y"];
                        else
                            dic["y"] = 0;
                        if (dic["x"] == 0)
                            this.Dic_Slide["x速度"] = 0;
                ...
                MyMouseEventStarling.prototype.enterFrameF = function () {
                    if (this.pausing == true)
                        return;
                    if (this.isDown == false)
                        return;
                ...
                MyMouseEventStarling.prototype.destroyF = function () {
                    if (this.MC) {
                    ...
                    MyClass.MainManager.getInstence().removeEnterFrameFun(this.enterFrameF);
                    if (this.FunEnter) {
                        this.FunEnter.clear();
                        this.FunEnter = null;
                    }
            ...
            MyView.MyMouseEventStarling = MyMouseEventStarling;
        })(MyView = MyClass.MyView || (MyClass.MyView = {}));
    })(MyClass = com.MyClass || (com.MyClass = {}));
})(com || (com = {}));
//# sourceMappingURL=MyMouseEventStarling.js.map